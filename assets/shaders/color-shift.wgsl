...
#import "shaders/blend.wgsl"::blendNormal_opacity
...
@group(0) @binding(2) var<uniform> color_shift: ComputedColorShift;

// `xyY`
const COLOR_SPACE: u32 = 2u;
...
fn main(in: FullscreenVertexOutput) -> @location(0) vec4<f32> {
    ...
    for (var i = 0; i < 5; i++) {
        ...
        color_shifted = blendNormal_opacity(
            color_shifted,
            color_shift_rgb,
            color_shift.a
        );
